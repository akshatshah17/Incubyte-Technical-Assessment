...
def add_entry(fields,table):
    stmt = "INSERT INTO " + table + " (Customer_Name,Customer_ID,Customer_Open_Date,Last_Consulted_Date,Vaccination_Type,Doctor_Consulted,State,Date_Of_Birth,Active_Customer) VALUES ('" + fields[0] + "','" + fields[1] + "','" + fields[2] + "','" + fields[3] + "','"+ fields[4] + "','" + fields[5] + "','" + fields[6] + "','" + fields[8] + "','" + fields[9] + "')"
    cursor.execute(stmt)
...
for line in f:
    ...
    fields[8] = fields[8][4:8]+fields[8][2:4]+fields[8][0:2]
